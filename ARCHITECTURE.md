...
- `[[grading_standards]]` — each entry created via `course.add_grading_standards()` if title not already present; first standard's ID passed as `grading_standard_id` in the course update
